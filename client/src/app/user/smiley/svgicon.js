 ...
 * 
 * added custom event 'svgEvent' 
 * to be triggered by angular
 *
...
;( function( window ) {
	...
	SvgIcon.prototype._initEvents = function() {
		...
		else if(this.options.evtoggle === 'click' || this.options.evtoggle === 'touchstart' ) {
			this.el.addEventListener( this.clickevent, toggleFn );
		} else {
			this.el.addEventListener('svgEvent', toggleFn);
		}
	};
